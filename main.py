...
for agent in agents:
    ...
    agent.speak_probability_mean = calc_speak_probability_mean(2/6,1/6,3/6,agent.assertiveness,agent.extraversion,agent.safety_mean)
    agent.reaction_probability   = calc_reaction_probability(2/6,1/6,3/6,agent.id,agents)
